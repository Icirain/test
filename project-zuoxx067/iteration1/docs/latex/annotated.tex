...
\item\contentsline{section}{\hyperlink{classMotionHandlerObstacle}{Motion\+Handler\+Obstacle} \\*A class used to manage the speed of obstacles. Currently speed on both sides are set same }{\pageref{classMotionHandlerObstacle}}{}
