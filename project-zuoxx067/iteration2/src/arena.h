...
class Arena {
  ...
  **/
   ...
   * If the checked instance is Lights, the function UpdateEntitiesTimestepLights will be called inside to do corresponding check
   * On the contrast if robot confronted, UpdateEntitiesTimestepRobot will be called.
   */
  void UpdateEntitiesTimestep();
  /**
   *
   * @param[in] The address of Lights waiting to be checked if collided with other entities
   ...
   *
   */
  void UpdateEntitiesTimestepLights(Lights* obstacle_entity_);
  /**
   *
